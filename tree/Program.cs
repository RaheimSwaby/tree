...
namespace tree
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            tree.Root.Children[0].Children[0].Children[2].Children = 
                [
                new () {Data = 6, Parent= tree.Root.Parent.Parent.Children[1]},
                ];
            tree.Root.Children[2].Children[0].Children[0].Children = 
                [
